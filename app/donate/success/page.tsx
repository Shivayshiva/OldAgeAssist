              ...
              <div className="pt-5 md:pt-6 border-t">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                  <div className="text-center p-3 md:p-4 bg-green-50 rounded-lg">
                    <p className="font-medium text-sm md:text-base">Nutritious Meals</p>
                  </div>
                  <div className="text-center p-3 md:p-4 bg-green-50 rounded-lg">
                    <p className="font-medium text-sm md:text-base">Medical Care</p>
                  </div>
                  <div className="text-center p-3 md:p-4 bg-green-50 rounded-lg">
                    <p className="font-medium text-sm md:text-base">Daily Comfort</p>
                  </div>
                </div>
              </div>
            </div>
