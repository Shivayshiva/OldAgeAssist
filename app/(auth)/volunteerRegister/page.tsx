...
import { Heart, Mail, User, Loader2, CheckCircle2 } from "lucide-react"
...
export default function VolunteerRegisterPage() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      setError("")
      await signIn("google", { 
        callbackUrl: "/volunteer/onboarding",
        redirect: true 
      })
    } catch (error) {
          ...
          <CardContent className="pt-8 pb-8 text-center space-y-6">
            <div className="flex justify-center">
              <div className="rounded-full bg-blue-100 dark:bg-blue-900 p-4">
                <Mail className="size-16 text-blue-600 dark:text-blue-400" />
              </div>
            </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4">
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block space-y-6 text-center lg:text-left">
          <div className="text-3xl font-bold bg-gradient-to-r from-primary via-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">
            Sirsa Foundation
          </div>
          ...
          <h1 className="text-4xl xl:text-5xl font-bold text-gray-900 dark:text-white leading-tight">
            ...
            <span className="text-primary block mt-2">Compassionate Volunteers</span>
          </h1>
          
          <p className="text-lg text-muted-foreground">
            Help bring joy and support to elderly residents. Your time and care can make 
        ...
        <Card className="w-full shadow-2xl border-0">
          <CardHeader className="text-center space-y-2 pb-8">
            ...
            <CardTitle className="text-3xl font-bold">Volunteer Registration</CardTitle>
