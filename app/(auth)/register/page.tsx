...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted/30 px-4 py-12">
      <Card className="w-full max-w-sm px-10 py-8 shadow-lg">
        ...
        <Button variant="outline" type="button" onClick={handleGoogleSignUp} disabled={googleLoading} className="w-full">
